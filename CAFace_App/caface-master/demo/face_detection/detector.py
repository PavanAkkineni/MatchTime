...
class FaceDetector():
    def __init__(self, device='cuda:0', output_shape=(256,256), model='lffd_slim'):
        if model == 'lffd_original':
            ...
            self.model = ff.FaceDetector.from_checkpoint("/work/users/a/k/akkineni/Matchtime/MatchTime/CAFace_App/caface-master/demo/face_detection/lffd_slim.ckpt").eval()
