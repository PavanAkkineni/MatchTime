...
if __name__ == '__main__':
    ...
    parser.add_argument("--video_path", type=str, default='/work/users/a/k/akkineni/Matchtime/MatchTime/models/1min30sec/2015-02-21 - 18-00 Chelsea 1 - 1 Burnley_1532_1629_substitution.mkv')
    parser.add_argument("--save_root", type=str, default='/work/users/a/k/akkineni/Matchtime/MatchTime/CAFace_App/caface-master/demo/res1/example1')
    ...
    for frame_num in tqdm(range(0, video_length, 10), total=video_length // 20):
        ret, frame = video.read()
        detected = detector.detect(frame)
        aligned = aligner.align(detected)
        #print('hi++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++')
        frame_path = os.path.join(save_dir, 'frame', f'{frame_num}.jpg')
    ...
    print("probe_fused_feature",probe_fused_feature.shape)
    print("probe_weights",probe_weights.shape)
    # infer gallery for comparison with probe video
    gallery_path = "/work/users/a/k/akkineni/Matchtime/MatchTime/CAFace_App/caface-master/assets/gallery.webp"
    #print('hi')
