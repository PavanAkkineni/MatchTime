...
from newpipe1 import process_all_videos
...
parser.add_argument("--cluster_root", type=str, default='/work/users/a/k/akkineni/Matchtime/MatchTime/models/uniquefaces_new04')
parser.add_argument("--gallery_dir", type=str, default='/work/users/a/k/akkineni/Matchtime/MatchTime/models/player_images1/england_epl_2014-2015')
parser.add_argument("--save_root", type=str, default='/work/users/a/k/akkineni/Matchtime/MatchTime/CAFace_App/caface-master/demo/cluster_res_new04player1')
