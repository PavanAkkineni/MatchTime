...
def predict(args):
    ...
    # test_dataset = Goal_Dataset(feature_root=args.feature_root, ann_root=args.ann_root, window=args.window, fps=args.fps, tokenizer_name=args.tokenizer_name, timestamp_key="gameTime", stage="test", val_length=49)
    ...
    headers = ['game', 'timestamp', 'type', 'anonymized']
...
if __name__ == "__main__":
    ...
    parser.add_argument("--feature_root", type=str, default="/work/users/a/k/akkineni/Matchtime/MatchTime/features/baidu_soccer_embeddings/england_epl_2014-2015/2015-02-21 - 18-00 Chelsea 1 - 1 Burnley")
    parser.add_argument("--ann_root", type=str, default="/work/users/a/k/akkineni/Matchtime/MatchTime/dataset/new1/england_epl_2014-2015/2015-02-21 - 18-00 Chelsea 1 - 1 Burnley")
    parser.add_argument("--model_ckpt", type=str, default="./ckpt/CLIP_matchvoice.pth")
    parser.add_argument("--window", type=float, default=window_size)
    ...
    parser.add_argument("--csv_output_path", type=str, default=f"./inference_result/reproduce_results/predict_internvideo_window_{window_size}_noalign.csv", help="the path to the output predictions")
