...
output_folder_1min30sec = "/work/users/a/k/akkineni/Matchtime/MatchTime/models/1min30sec_new6"


valid_annotations = extract_valid_annotations(dataset_path)
#print(len(valid_annotations))
#print(len(valid_annotations[200:]))
#exit()
# Save extracted video clips and annotations
annotations_dict = {}
for annotation in valid_annotations[200:]:
